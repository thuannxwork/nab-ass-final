package com.nab.common.constants;
...
public class WebConstants {
	...
	public static final String PROD_CATEGORY = "categoryid";
	public static final String PROD_BRAND = "brandid";
	public static final String PROD_COLOR = "color";
	public static final String PROD_FROM_PRICE = "fromPrice";
	public static final String PROD_TO_PRICE = "toPrice";
	...
	public static final String FEIGN_CLIENT_INVENTORY = "inventory";
	public static final String FEIGN_CLIENT_SSO = "sso";
