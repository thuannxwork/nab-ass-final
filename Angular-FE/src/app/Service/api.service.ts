...
export class ApiService {
  ...
  findProducts(categoryId: string, brandId: string, color: string, fromPrice: string, toPrice: string): Observable<any> {
    return this.http.get<any>(environment.baseUrl + environment.findProductsUrl + '?categoryid=' + categoryId
      + '&brandid=' + brandId + '&color=' + color + '&fromPrice=' + fromPrice + '&toPrice=' + toPrice);
  }

  // Add product in the system
  addProduct(desc: string,
             quan: string, price: string, prodname: string, image: File,
             category: string, brand: string, color: string): Observable<any> {
  ...
  getAllCategory(): Observable<any> {
    return this.http.get<any>(environment.baseUrl + environment.categoryUrl);
  }

  getBrand(categoryId: any): Observable<any> {
    return this.http.get<any>(environment.baseUrl + environment.brandUrl + '?categoryid=' + categoryId);
  }
}
